...
const TradingViewSplineAreaChart = (props) => {
    ...
    if (data_for_pnl_graph.length == 0) {
      ...
      if (data_for_pnl_graph && chartContainerRef.current) {
        ...
        chartRef.current = createChart(chartContainerRef.current, {
          ...
          layout: {
            backgroundColor: "#ffffff", // Set background color to transparent
          ...
          grid: {
            vertLines: {
              visible: false,
              color: "#ffffff", // Set vertical grid lines color to transparent
              //   lineWidth: 1, // Set a fixed width for the vertical grid lines
            },
            horzLines: {
              visible: false,
              color: "#ffffff", // Set horizontal grid lines color to transparent
  ...
  return (
    <div
      ...
      style={{ width: "150px", height: "10px" }} // Set a fixed width and height
    />
  );
};

export default TradingViewSplineAreaChart;
