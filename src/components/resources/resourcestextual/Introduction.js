      ...
      <div className="res-textual">
        <div className="res-textual-section">
          <div className="container">
            <h1 className='res-det-heading for-text-align derivations-h1'>Zero Theorem</h1>
            <h2 className="for-mt-secondary for-text-align derivations-h2">An Economic Framework for Valuing Bitcoin</h2>
            <h3 className="for-mt-secondary for-text-align derivations-h3">&#8212; By SOREZ</h3>
