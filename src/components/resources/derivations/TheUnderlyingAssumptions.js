        ...
        <div className="res-textual-section">
          <div className="container">
            ...
            <p className="for-mt-secondary">
              <strong>Assumption 1:</strong>  Value (purchasing power) cannot be created or destroyed and is finite in
              ...
              <br/>
              <br/>
              <strong>Assumption 2:</strong> In short time horizons, the aggregate change of value for all assets within the
              ...
              <br/>
              <br/>
              <strong>Assumption 3:</strong> Substitution is driven by Markowitz portfolio optimisations from which
