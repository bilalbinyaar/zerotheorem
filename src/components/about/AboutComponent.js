...
const AboutComponent = () => {
  ...
  return (
    ...
    //     <div className="about-head for-mb">
    //       <h1>
    //         WHAT IS <span className="color-yellow">ZERO</span> THEOREM?
    //       </h1>
    //     </div>

    //     <div className="about-text for-mb">
    //       <p>
    ...
    //         Governing Equations that value digital assets. The resultant output
    //         of the proof is a range of forward price estimations (or forecasted
    //         directions) for Bitcoin and like proof of work (PoW)
    //         crypto-currencies.
    //       </p>
    //     </div>

    //     <div className="about-video for-mb">
    ...
    //     <div className="about-text for-mb">
    //       <p>
    //         The Zero Theorem governing equations are derived partly from the
    //         three following assumptions:
    //       </p>
    //     </div>

    //     <div className="about-text for-mb">
    //       <h2>Assumption 1 (A1)</h2>
    //       <p>
    //         Value (purchasing power) cannot be created or destroyed and is
    //         finite in substance. Hence the entire financial eco-system is
    //         predicated ZERO sum game dynamics. A1 Example: For one asset to
    //         increase in market capitalisation there needs to be another asset
    //         (or multiple assets) that equivalently decrease in market
    //         capitalisation.
    //       </p>
    //     </div>

    //     <div className="about-text for-mb">
    //       <h2>Assumption 2 (A2)</h2>
    //       <p>
    //         In short time horizons, the aggregate change of value for all assets
    //         within the financial eco-system must equate to ZERO in order to
    //         maintain finite substance condition in A1. Changes in the value of
    //         PoW digital assets, can only be occurring via some form of
    //         substitution phenomenon (here denoted as α). Therefore, α must be
    //         bi-directional in nature representing the rate of value
    //         absorption/dispersion from alternative asset within its own class as
    //         well as assets outside of its class.
    //       </p>
    //     </div>

    //     <div className="about-text for-mb">
    //       <h2>Assumption 3 (A3)</h2>
    //       <p>
    //         α is driven by Markowitz portfolio optimisations from which multiple
    //         rational economic agents which are competing to maximise individual
    //         investor utility whilst minimising their individual portfolio risk
    //         as close to ZERO as physically possible. A3 suggests economic agents
    //         tend to embrace PoW digital assets as a superior store of value
    //         (especially considering larger time horizons of years) which combat
    //         inflation and provide a unique hedge against systemic risk in the
    //         traditional financial system and/or traditional currencies.
    //       </p>
    //     </div>

    //     <div className="about-head for-mb for-mt">
    //       <h1>
    //         PROVING <span className="color-yellow">ZERO</span> THEOREM
    //       </h1>
    //     </div>
    //     <div className="about-text for-mb">
    //       <p>
    //         If Zero Theorem is truly the absolute economic framework for PoW
    //         digital assets, its ability to effectively and consistently predict
    //         directional movements should be unquestionable with practical
    //         consequence. We believe the only way to validate this is to observe
    //         Zero Theorem forecasts in their most sort after use case,
    //         Quantitative Trading.
    //       </p>
    //     </div>
    //     <div className="about-text for-mb">
    //       <p>
    //         Quantitative trading is the process of extracting market
    //         inefficiencies through trading against temporary price dislocations.
    //         We classify inefficiencies as temporary dislocation of prices away
    //         from its “fair-value” equilibrium level. This typically originates
    //         from actions taken by market participants who are either irrational
    //         and/or uninformed and/or lacking proper pricing sophistication to
    //         determine what a “fair-value” price is. If many participants suffer
    //         from the above conditions their aggregate market impact adversely
    //         interferes with modern day market mechanics. This may result in
    //         dislocated prices often persisting temporarily in the opposite
    //         direction of where they should go.
    //       </p>
    //     </div>
    //     <div className="about-text for-mb">
    //       <p>
    //         For Zero Theorem to be proved as a legitimate solution to the PoW
    //         pricing dilemma it should be able to consistently identify price
    //         dislocation opportunities (from its directional forecasts) and by
    //         utilising these outputs via the primary use case, one should
    //         generate:
    //       </p>
    //     </div>
    ...
    //         <span>
    //           <p className="for-weight">1. </p>
    //         </span>
    //         <span>
    //           <p>{"A positive yield structures"}</p>
    //         </span>
    //       </div> */}
    //       <div className="about-spans">
    //         <span>
    ...
    //         <span>
    //           <p>
    //             A positive yield structure that outperforms the underlying
    //             market itself
    //           </p>
    //         </span>
    //       </div>
    ...
    //         <span>
    //           <p>
    //             A positive yield structure that is statistically uncorrelated
    ...
    //         <span>
    //           <p>
    //             A positive yield structure that outperforms any other competing
    ...
    //     <div className="about-text for-mb">
    //       <p>
    //         On our website you will find a wide range of machine learning models
    //         and potential solutions to the Zero Theorem Governing equations. The
    //         forecasts generated from these solutions are evaluated on their
    //         hypothetical trading performance (via primary use case). Over time
    //         new models and solutions will be added encompassing a range of
    //         different forecasted time horizons and alternative PoW currencies.
    //       </p>
    //     </div>
    ...
    //             WHO IS<span className="color-yellow"> SOREZ?</span>
    //           </h1>
    //           <div className="about-text text-align-left for-mb">
    //             <p>
    //               We are a pseudonymous group of quantitative researchers
    //               responsible for the Zero Theorem infrastructure, governing
    //               equations and machine learning models. Our mission is to
    //               identify a single solution or set of solutions that
    //               empirically validate Zero Theorem governing equations for
    //               multiple time horizons and multiple PoW digital assets. This
    //               is a hobby project which aims to release free information to
    //               the public in the hope that it may improve pricing certainty,
    //               increase confidence and provide a robust framework to value
    //               digital assets.
    //             </p>
    //           </div>
    //         </div>
