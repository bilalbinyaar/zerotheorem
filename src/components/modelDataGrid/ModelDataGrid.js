  ...
  const columns = [
    ...
    // },
    {
      ...
      renderHeader: (params) => (
        <strong>
          {"Model "}
          <Tooltip className="performance-table-tooltip" title="Model name, time horizon, and currency">
            <IconButton>
    ...
    },
    {
      ...
      renderHeader: (params) => (
        <strong>
          {"Start Date "}
          <Tooltip className="performance-table-tooltip" title="Forecasts start date">
            <IconButton>
              <BsFillInfoCircleFill />
            </IconButton>
          </Tooltip>
    ...
    },
    {
      ...
      renderHeader: (params) => (
        <strong>
          {"Forecast "}
          <Tooltip className="performance-table-tooltip" title="Price/Directional prediction for current time">
            <IconButton>
              <BsFillInfoCircleFill />
            </IconButton>
          </Tooltip>
...

    {
      ...
      renderHeader: (params) => (
        <strong>
          {"Forecast Time"}
          <Tooltip className="performance-table-tooltip" title="Time in which the forecast is created (in local system time)">
            <IconButton>
              <BsFillInfoCircleFill />
            </IconButton>
          </Tooltip>
...

    {
      ...
      renderHeader: (params) => (
        <strong>
          {"Next Forecast "}
          <Tooltip className="performance-table-tooltip" title="Countdown clock till time of next forecast">
            <IconButton>
              <BsFillInfoCircleFill />
            </IconButton>
          </Tooltip>
...

    {
      ...
      renderHeader: (params) => (
        <strong>
          {"Avg Daily PNL"}
          <Tooltip className="performance-table-tooltip" title="Avg daily PNL">
            <IconButton>
              <BsFillInfoCircleFill />
            </IconButton>
          </Tooltip>
...

    {
      ...
      renderHeader: (params) => (
        <strong>
          {"7d PNL "}
          <Tooltip className="performance-table-tooltip" title="PNL of last 7 days">
            <IconButton>
              <BsFillInfoCircleFill />
            </IconButton>
          </Tooltip>
...

    {
      ...
      renderHeader: (params) => (
        <strong>
          {"Total PNL "}
          <Tooltip className="performance-table-tooltip" title="The total profit (or loss) generated by the model (aggregate profit minus aggregate loss)
">
            <IconButton>
              <BsFillInfoCircleFill />
            </IconButton>
...

    {
      ...
      renderHeader: (params) => (
        <strong>
          {"PNL Graph "}
          <Tooltip className="performance-table-tooltip" title="Cummulative PNL graph w.r.t time">
            <IconButton>
              <BsFillInfoCircleFill />
            </IconButton>
          </Tooltip>
