...
export const questions = [
    {
        ...
        answer: <p className="answers-api">Zero Theorem is an economic framework consisting of state-of-the-art machine learning methods used for an empirical proof on a set of governing equations that value digital assets. The resultant output of the proof is a range of forward price estimations (or forecasted directions) for Bitcoin and similar proof of work (PoW) crypto-currencies. If you like to dive deep into the math please go to our {link} page. </p>
    },

    {
        id: 2,
        question: 'What is the Zero Proof Protocol?',
        answer: 'If a pricing theory has true descriptive power its ability to predict directional movements effectively and consistently should be unquestionable with practical consequence. The Zero Proof Protocol is an empirical method of proving pricing models via subjecting them to real life market conditions and monitoring their hypothetical trading performance. All models on Zero Theorem are utilizing a Zero Proof Protocol in order to validate their legitimacy.'
    },
    ...
    {
        id: 4,
        question: 'If the governing equations can be analytically solved, why is there a need for an RL solution?',
...
export const questions1 = [
    {
        ...
        answer: <p className="answers-api">The Zero Theorem governing equation can be analytically solved if one has a solution to the time dependent value for 𝛼<sub>𝑘</sub> for k quantity of markets. Since the substitution phenomena is unknown, we opt to use deep reinforcement learning to forecast this variable for every k market for every time interval. </p>
    },
...

    {
        ...
        answer: 'The models have been thoroughly back tested on both seen and unseen data sets. The metrics shown on the website are a combination of the back tested results and the inclusion of live data moving forward. Every day new metrics are calculated based on the live performance of the previous day.'
    },

    {
        id: 9,
        question: 'Where do I find the accuracy statistics per model?',
        answer: 'The accuracy of any model can be viewed directly at the bottom of its individual page. There you will find the specific drawdown, win/loss metrics and general statistics that make up the overall performance of a model.'
    },

    {
        id: 10,
        question: 'What are the ranking criteria between model forecasts?',
        answer: 'At the moment models are ranked based on their total achieved yield. Please note that this may not be the optimal metric to rank models.'
    },
]
...
export const questions2 = [
    {
        ...
        answer: 'In futures trading lingo, long means one is buying a positive contract (if the price increases one makes money from the appreciation and if the price decreases one losses money from the depreciation). The opposite of long is a short, where one is buying a negative contract (if the price decreases one makes money from the depreciation and if the price increases on losses money from the appreciation). '
    },
    ...
    {
        id: 13,
        question: 'Why are there no risk controls (stop loss/take profit) being applied to the directional forecast of the models?',
        answer: 'Our goal is to prove that models resulting from the Zero Theorem governing equations do produce superior foresight and performance without the need of risk control interventions. Risk controls themselves should only enhance a model’s already inherent performance to drive up yield consistency and reduce drawdown intensity and durations.'
    },

    {
        id: 14,
        question: 'Are trading fees taken into account within the performance analysis?',
        answer: 'No. Trading fees are not taken into account as of yet. There will be a feature in the future that will allow users to observe the impact of trading fees for all individual models.'
    },
