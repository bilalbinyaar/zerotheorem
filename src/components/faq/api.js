...
export const questions = [
    {
        id: 1,
        question: 'What is the Zero Theorem?',
    ...
    {
        id: 4,
        question: 'If the governing equations can be analytically solved, why is there a need for RL solution?',
...
export const questions1 = [
    ...
    {
        id: 9,
        question: 'Where do find the accuracy statistics per model?',
...
export const questions2 = [
    {
        ...
        answer: 'In futures trading lingo, long means one is buying a positive contract (if the price increases one makes money from the appreciation and if the price decreases one losses money from the deprecation). The opposite of long is a short, where one is buying a negative contract (if the price decreases one makes money from the depreciation and if the price increases on losses money from the appreciation). '
    },

    {
        id: 12,
        question: 'What time is the are the hypothetical trades being opened and closed?',
