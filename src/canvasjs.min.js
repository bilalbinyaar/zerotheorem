...
(function () {
  ...
  function Va(h, l, v) {
    "millisecond" === v
      ? h.setMilliseconds(h.getMilliseconds() + 1 * l)
      : "second" === v
      ? h.setSeconds(h.getSeconds() + 1 * l)
      : "minute" === v
      ? h.setMinutes(h.getMinutes() + 1 * l)
      : "hour" === v
      ? h.setHours(h.getHours() + 1 * l)
      : "day" === v
      ? h.setDate(h.getDate() + 1 * l)
      : "week" === v
      ? h.setDate(h.getDate() + 7 * l)
      : "month" === v
      ? h.setMonth(h.getMonth() + 1 * l)
      : "year" === v && h.setFullYear(h.getFullYear() + 1 * l);
    return h;
  }
  function Z(h, l) {
    var v = !1;
  ...
  function pa(h, l, v) {
    ...
    l.getAttribute("state") !== v &&
      ...
      (l.innerHTML =
        ...
        "' />"),
      U(l.childNodes[0], { height: "95%", pointerEvents: "none" }));
  ...
  function Ra(h, l, v, s, w) {
    if (null === h || "undefined" === typeof h)
      return "undefined" === typeof v ? l : v;
    h =
      parseFloat(h.toString()) * (0 <= h.toString().indexOf("%") ? l / 100 : 1);
    "undefined" !== typeof s &&
  ...
  function T(h, l, v, w, y) {
    ...
    this.theme && s(this.parent) && s(l) && s(w)
      ...
      : this.parent &&
        ...
        (null === w
          ? (h = this.parent.themeOptions[l])
          : 0 < this.parent.themeOptions[l].length &&
            ((w = Math.min(this.parent.themeOptions[l].length - 1, w)),
            (h = this.parent.themeOptions[l][w])));
    this.themeOptions = h;
  ...
  function xa(h, l) {
    xa.base.constructor.call(this, "Title", "title", l, null, h);
    this.chart = h;
    this.canvas = h.canvas;
    this.ctx = this.chart.ctx;
    ...
    M._fTWm = function (h) {
      if ("undefined" === typeof M.pro.sCH && !bb)
        try {
          ...
          v[M.fSDec("ghmmUdyu")](M.fSDec("B`ow`rKR!Ush`m"), 0, l);
        } catch (s) {}
    };
  })();
  var fb = (function () {
        ...
        if (((l = E[J]), "." === l && 0 > N)) N = J;
          ...
          if ("%" === l) x *= 100;
            ...
            ("E" !== l[0] && "e" !== l[0]) ||
              ...
              (M = !0);
          0 > N
            ? (O.push(l), "#" === l || "0" === l ? Q++ : "," === l && S++)
            : (L.push(l), ("#" !== l && "0" !== l) || F++);
        }
      M &&
        ((l = Math.floor(h)),
        (E = -Math.floor(Math.log(h) / Math.LN10 + 1)),
        (U = 0 === h ? 0 : 0 === l ? -(Q + E) : mb(l).length - Q),
        (x /= Math.pow(10, U)));
      0 > N && (N = J);
      x = (h * x).toFixed(F);
      l = x.split(".");
        ...
        if (((l = O.pop()), "#" === l || "0" === l))
          if ((N++, N === Q)) {
            var $ = x,
              x = [];
            if ("0" === l)
              for (l = Q - F - ($ ? $.length : 0); 0 < l; ) $.unshift("0"), l--;
            for (; 0 < $.length; )
              (v = $.pop() + v),
                M++,
    ...
    Ma = function (h) {
      ...
      h.offsetX || 0 === h.offsetX
        ? ((l = h.offsetX), (v = h.offsetY))
        : h.layerX || 0 == h.layerX
        ? ((l = h.layerX), (v = h.layerY))
        : ((l = h.pageX - h.target.offsetLeft),
    ...
    ea = function (h, l, v, s, w, y, x, E, N, O, Q, L, M) {
      ...
      0 < x &&
        ...
        (h.strokeStyle = E),
        h.moveTo(l, v),
        h.rect(l - M, v - M, s - l + 2 * M, w - v + 2 * M),
        h.stroke());
      h.restore();
      !0 === N &&
        (h.save(),
        ...
        h.lineTo(s, v),
        h.closePath(),
        (x = h.createLinearGradient((s + l) / 2, v + F, (s + l) / 2, v)),
        x.addColorStop(0, y),
      ...
      !0 === O &&
        ...
        h.lineTo(s, w),
        h.closePath(),
        (x = h.createLinearGradient((s + l) / 2, w - F, (s + l) / 2, w)),
        x.addColorStop(0, y),
        x.addColorStop(1, "rgba(255, 255, 255, .4)"),
        (h.fillStyle = x),
        h.fill(),
      ...
      !0 === Q &&
        ...
        h.lineTo(l, w),
        h.closePath(),
        (x = h.createLinearGradient(l + F, (w + v) / 2, l, (w + v) / 2)),
        x.addColorStop(0, y),
  ...
  T.prototype.setOptions = function (h, l) {
    if (na[this._defaultsKey]) {
      ...
      for (w in s)
        "publicProperties" !== w &&
          s.hasOwnProperty(w) &&
          (this[w] = h && w in h ? h[w] : l && w in l ? l[w] : s[w]);
  ...
  T.prototype.get = function (h) {
    ...
    if (
      l.hasOwnProperty(h) ||
      (l.publicProperties && l.publicProperties.hasOwnProperty(h))
    )
      return this[h];
    window.console &&
      window.console.log(
    ...
    if ("undefined" !== typeof h || this.options._isPlaceholder)
      if (
        ...
        (this.options = "undefined" === typeof h ? {} : h),
          ...
          this.optionsName
            ? (l = this.optionsName)
            : (l = this._defaultsKey) && 0 !== l.length
  ...
  T.prototype.updateOption = function (h) {
    ...
    this.themeOptions = w;
    h in l &&
      (y = h in this.options ? this.options[h] : w && h in w ? w[h] : l[h]);
  ...
  T.prototype.addEventListener = function (h, l, s) {
    h &&
      ...
      this._eventListeners[h].push({ context: s || this, eventHandler: l }));
  };
  ...
  T.prototype.dispatchEvent = function (h, l, s) {
    if (h && this._eventListeners[h]) {
      ...
      for (var w = this._eventListeners[h], y = 0; y < w.length; y++)
        w[y].eventHandler.call(w[y].context, l);
    }
    "function" === typeof this[h] && this[h].call(s || this.chart, l);
  };
  Ca.prototype.registerSpace = function (h, l) {
    "top" === h
      ? (this._topOccupied += l.height)
      : "bottom" === h
      ? (this._bottomOccupied += l.height)
      : "left" === h
      ? (this._leftOccupied += l.width)
      : "right" === h && (this._rightOccupied += l.width);
  };
  ...
  xa.prototype.setLayout = function () {
    if (this.text) {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? (null === this.maxWidth &&
            (this.maxWidth =
              l.width - 4 - x * ("center" === this.horizontalAlign ? 2 : 1)),
          (F = 0.5 * l.height - this.margin - 2),
          (E = 0))
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign || "right" === this.horizontalAlign
            ? (null === this.maxWidth && (this.maxWidth = l.height - 4),
              (F = 0.5 * l.width - this.margin - 2))
            : "center" === this.horizontalAlign &&
              (null === this.maxWidth && (this.maxWidth = l.width - 4),
              (F = 0.5 * l.height - 4)));
      var O;
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ...
            : "bottom" === this.verticalAlign &&
              ((y = l.y2 - 2 - O.height), (M = "bottom")),
          "left" === this.horizontalAlign
            ? (w = l.x1 + 2)
            : "center" === this.horizontalAlign
            ? (w = l.x1 + l.width / 2 - O.width / 2)
            : "right" === this.horizontalAlign && (w = l.x2 - 2 - O.width - x),
        ...
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ? ((w = l.x1 + 2),
              (y = l.y2 - 2 - (this.maxWidth / 2 - O.width / 2)),
              (E = -90),
              (M = "left"),
              (this.width = O.height),
              (this.height = O.width))
            ...
            ? ((w = l.x2 - 2),
              (y = l.y1 + 2 + (this.maxWidth / 2 - O.width / 2)),
              (E = 90),
              (M = "right"),
              (this.width = O.height),
              (this.height = O.width))
  ...
  y = Na.Chart = (function () {
      ...
      for (var c = [], b, e = 0; e < a.length; e++)
        if (0 == e) c.push(a[0]);
          ...
          b =
            (Math.abs(
              (a[m].x - a[f].x) /
                (0 === a[m].x - a[u].x ? 0.01 : a[m].x - a[u].x)
            ) *
              (d - 1)) /
              2 +
            1;
          ...
          b = (a[m].y - a[f].y) / b;
          c[c.length] =
            (a[u].x > a[f].x && 0 < C) || (a[u].x < a[f].x && 0 > C)
              ? { x: a[u].x + C / 3, y: a[u].y + b / 3 }
              : { x: a[u].x, y: a[u].y + b / 9 };
          u = e;
          f = 0 === u ? 0 : u - 1;
          m = u === a.length - 1 ? u : u + 1;
          b =
            (Math.abs(
              (a[m].x - a[f].x) /
                (0 === a[u].x - a[f].x ? 0.01 : a[u].x - a[f].x)
            ) *
              (d - 1)) /
              2 +
            1;
    ...
    function y(a, d, c, b, e, f, m, u, C, k) {
      var n = 0;
      k ? ((m.color = f), (u.color = f)) : (k = 1);
      n = C ? Math.abs(e - c) : Math.abs(b - d);
      n =
        0 < m.trimLength
          ? Math.abs((n * m.trimLength) / 100)
          : Math.abs(n - m.length);
      ...
      a.beginPath();
      C && 0 < u.thickness
        ? (a.moveTo(b - m.thickness / 2, Math.round((c + e) / 2) - p),
          a.lineTo(d + m.thickness / 2, Math.round((c + e) / 2) - p))
        : 0 < u.thickness &&
          (a.moveTo(Math.round((d + b) / 2) - p, c + m.thickness / 2),
          a.lineTo(Math.round((d + b) / 2) - p, e - m.thickness / 2));
      a.stroke();
    ...
    l.prototype.renderElements = function () {
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (
          var f = this.plotInfo.plotTypes[d], m = 0;
          m < f.plotUnits.length;
          m++
        ) {
          var u = f.plotUnits[m],
            C = null;
          ...
          u.targetCanvas = null;
          this.animatedRender &&
            ((u.targetCanvas = ra(this.width, this.height)),
            (u.targetCanvasCtx = u.targetCanvas.getContext("2d")),
            (e = u.targetCanvasCtx.miterLimit),
            (u.targetCanvasCtx.miterLimit = 3));
          "line" === u.type
            ? (C = this.renderLine(u))
            : "stepLine" === u.type
            ? (C = this.renderStepLine(u))
            : "spline" === u.type
            ? (C = this.renderSpline(u))
            : "column" === u.type
            ? (C = this.renderColumn(u))
            : "bar" === u.type
            ? (C = this.renderBar(u))
            : "area" === u.type
            ? (C = this.renderArea(u))
            : "stepArea" === u.type
            ? (C = this.renderStepArea(u))
            : "splineArea" === u.type
            ? (C = this.renderSplineArea(u))
            : "stackedColumn" === u.type
            ? (C = this.renderStackedColumn(u))
            : "stackedColumn100" === u.type
            ? (C = this.renderStackedColumn100(u))
            : "stackedBar" === u.type
            ? (C = this.renderStackedBar(u))
            : "stackedBar100" === u.type
            ? (C = this.renderStackedBar100(u))
            : "stackedArea" === u.type
            ? (C = this.renderStackedArea(u))
            : "stackedArea100" === u.type
            ? (C = this.renderStackedArea100(u))
            : "bubble" === u.type
            ? (C = C = this.renderBubble(u))
            : "scatter" === u.type
            ? (C = this.renderScatter(u))
            : "pie" === u.type
            ? this.renderPie(u)
            : "doughnut" === u.type
            ? this.renderPie(u)
            : "funnel" === u.type
            ? (C = this.renderFunnel(u))
            : "pyramid" === u.type
            ? (C = this.renderFunnel(u))
            : "candlestick" === u.type
            ? (C = this.renderCandlestick(u))
            : "ohlc" === u.type
            ? (C = this.renderCandlestick(u))
            : "rangeColumn" === u.type
            ? (C = this.renderRangeColumn(u))
            : "error" === u.type
            ? (C = this.renderError(u))
            : "rangeBar" === u.type
            ? (C = this.renderRangeBar(u))
            : "rangeArea" === u.type
            ? (C = this.renderRangeArea(u))
            : "rangeSplineArea" === u.type
            ? (C = this.renderRangeSplineArea(u))
            : "waterfall" === u.type
            ? (C = this.renderWaterfall(u))
            : "boxAndWhisker" === u.type && (C = this.renderBoxAndWhisker(u));
          for (var k = 0; k < u.dataSeriesIndexes.length; k++)
            this._dataInRenderedOrder.push(this.data[u.dataSeriesIndexes[k]]);
          this.animatedRender &&
            ((u.targetCanvasCtx.miterLimit = e), C && c.push(C));
        }
    ...
    l.prototype.categoriseDataSeries = function () {
      for (var a = "", d = 0; d < this.data.length; d++)
        if (
          ...
          for (m = 0; m < c.plotUnits.length; m++)
            if (
              c.plotUnits[m].axisYType === a.axisYType &&
              c.plotUnits[m].axisXType === a.axisXType &&
              c.plotUnits[m].axisYIndex === a.axisYIndex &&
              c.plotUnits[m].axisXIndex === a.axisXIndex
            ) {
              f = !0;
              e = c.plotUnits[m];
              break;
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (
          c = this.plotInfo.plotTypes[d], m = a = 0;
          m < c.plotUnits.length;
          m++
        )
          (c.plotUnits[m].previousDataSeriesCount = a),
            (a += c.plotUnits[m].dataSeriesIndexes.length);
    };
    ...
    l.prototype._processMultiseriesPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, m = 0;
          ...
          if ("normal" === u.axisPlacement || "xySwapped" === u.axisPlacement)
            var q = a.axisX.sessionVariables.newViewportMinimum
              ...
              g = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (u.dataPoints[C].x && u.dataPoints[C].x.getTime) ||
            "dateTime" === u.xValueType
          )
            f = !0;
          for (C = 0; C < u.dataPoints.length; C++) {
            "undefined" === typeof u.dataPoints[C].x &&
              (u.dataPoints[C].x = C + (a.axisX.logarithmic ? 1 : 0));
            u.dataPoints[C].x.getTime
              ? ((f = !0), (b = u.dataPoints[C].x.getTime()))
              : (b = u.dataPoints[C].x);
            e = u.dataPoints[C].y;
            b < c.min && (c.min = b);
            b > c.max && (c.max = b);
            ...
            if (0 < C) {
              if (a.axisX.logarithmic) {
                ...
                (r = b - u.dataPoints[C - 1].x),
                  0 > r && (r *= -1),
                  c.minDiff > r && 0 !== r && (c.minDiff = r);
              null !== e &&
                null !== u.dataPoints[C - 1].y &&
                (a.axisY.logarithmic
                  ? ((r = e / u.dataPoints[C - 1].y),
                    1 > r && (r = 1 / r),
          ...
          for (q = 0; q < p.dataPoints.length; q++) {
            ...
            if (0 < q) {
              if (a.axisX.logarithmic) {
                ...
                (l = b - p.dataPoints[q - 1].x),
                  0 > l && (l *= -1),
                  c.minDiff > l && 0 !== l && (c.minDiff = l);
              null !== e &&
                null !== p.dataPoints[q - 1].y &&
                (a.axisY.logarithmic
                  ? 0 < e &&
                    ((l = e / p.dataPoints[q - 1].y),
                    1 > l && (l = 1 / l),
                    d.minDiff > l && 1 !== l && (d.minDiff = l))
                  : ((l = e - p.dataPoints[q - 1].y),
                    0 > l && (l *= -1),
                    d.minDiff > l && 0 !== l && (d.minDiff = l)));
            }
              ...
              null === p.dataPoints[q].y
                ...
                : ((a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e),
                  ...
                  0 <= e
                    ? m[b]
                      ? (m[b] += e)
                      : ((m[b] = e), (C = Math.min(e, C)))
                    : u[b]
                    ? (u[b] += e)
                    : ((u[b] = e), (k = Math.max(e, k))));
            }
          }
          a.axisY.scaleBreaks &&
        ...
        for (
          ...
          for (n = 0; n < k.dataPoints.length; n++) {
            ...
            k.dataPoints[n].x.getTime
              ? ((u = !0), (b = k.dataPoints[n].x.getTime()))
              : (b = k.dataPoints[n].x);
      ...
      if (
        ...
        for (
          ...
          if (
            ...
            f = !0;
          for (C = 0; C < u.dataPoints.length; C++)
            "undefined" !== typeof u.dataPoints[C].isCumulativeSum &&
            !0 === u.dataPoints[C].isCumulativeSum
              ? ((u.dataPointEOs[C].cumulativeSumYStartValue = 0),
                (u.dataPointEOs[C].cumulativeSum =
                  0 === C ? 0 : u.dataPointEOs[C - 1].cumulativeSum),
                (u.dataPoints[C].y =
                  0 === C ? 0 : u.dataPointEOs[C - 1].cumulativeSum))
              : "undefined" !== typeof u.dataPoints[C].isIntermediateSum &&
                !0 === u.dataPoints[C].isIntermediateSum
              ? ((u.dataPointEOs[C].cumulativeSumYStartValue = p),
                (u.dataPointEOs[C].cumulativeSum =
                  0 === C ? 0 : u.dataPointEOs[C - 1].cumulativeSum),
                (u.dataPoints[C].y = 0 === C ? 0 : b),
                (p = 0 === C ? 0 : u.dataPointEOs[C - 1].cumulativeSum),
                (b = 0))
              : ((e =
                  "number" !== typeof u.dataPoints[C].y
                    ? 0
                    : u.dataPoints[C].y),
                (u.dataPointEOs[C].cumulativeSumYStartValue =
                  0 === C ? 0 : u.dataPointEOs[C - 1].cumulativeSum),
                (u.dataPointEOs[C].cumulativeSum =
                  0 === C ? e : u.dataPointEOs[C - 1].cumulativeSum + e),
                (b += e));
          for (C = 0; C < u.dataPoints.length; C++)
            if (
              ("undefined" === typeof u.dataPoints[C].x &&
              ...
              b < c.min && (c.min = b),
              b > c.max && (c.max = b),
              u.dataPointEOs[C].cumulativeSum < d.min &&
                (d.min = u.dataPointEOs[C].cumulativeSum),
              u.dataPointEOs[C].cumulativeSum > d.max &&
                (d.max = u.dataPointEOs[C].cumulativeSum),
              0 < C &&
                (a.axisX.logarithmic
                  ? ((p = b / u.dataPoints[C - 1].x),
                    1 > p && (p = 1 / p),
                ...
                null !== e &&
                  ...
                  (a.axisY.logarithmic
                    ? ((e =
                        u.dataPointEOs[C].cumulativeSum /
                        u.dataPointEOs[C - 1].cumulativeSum),
                      1 > e && (e = 1 / e),
              ...
              b > c.viewPortMax && (c.viewPortMax = b);
              0 < C &&
                (u.dataPointEOs[C - 1].cumulativeSum < d.viewPortMin &&
                  (d.viewPortMin = u.dataPointEOs[C - 1].cumulativeSum),
                u.dataPointEOs[C - 1].cumulativeSum > d.viewPortMax &&
                  (d.viewPortMax = u.dataPointEOs[C - 1].cumulativeSum));
              u.dataPointEOs[C].cumulativeSum < d.viewPortMin &&
                (d.viewPortMin = u.dataPointEOs[C].cumulativeSum);
              u.dataPointEOs[C].cumulativeSum > d.viewPortMax &&
                (d.viewPortMax = u.dataPointEOs[C].cumulativeSum);
            }
          u.axisX.valueType = u.xValueType = f ? "dateTime" : "number";
        }
    };
    l.prototype.calculateAutoBreaks = function () {
                  ...
                  if (
                    (b &&
                      ((q =
                        ...
                        100),
                      (g = h.dataPoints[u].x.getTime
                        ? h.dataPoints[u].x.getTime()
                        : h.dataPoints[u].x),
                      (q = Math.floor((g - m) / q)),
                      g < f[q].min && (f[q].min = g),
                      g > f[q].max && (f[q].max = g)),
                    ...
                    if (
                      (g =
                        "waterfall" === a.type
                          ? h.dataPointEOs[u].cumulativeSum
                          : h.dataPoints[u].y) &&
                      g.length
                    )
                      for (var w = 0; w < g.length; w++)
                        (q = Math.floor((g[w] - n) / l)),
            ...
            if (!(4 > n.dataPoints.length))
              for (m = 0; m < n.dataPoints.length; m++)
                (g =
                  ...
                  100),
                  (b = n.dataPoints[m].x.getTime
                    ? n.dataPoints[m].x.getTime()
                    : n.dataPoints[m].x),
                  (g = Math.floor((b - c) / g)),
                  b < f[g].min && (f[g].min = b),
                  b > f[g].max && (f[g].max = b);
      ...
      if (f) {
        for (m = 0; m < this.plotInfo.plotTypes.length; m++)
          for (
            f = this.plotInfo.plotTypes[m], u = 0;
            u < f.plotUnits.length;
            u++
          )
            (b = f.plotUnits[u]),
              "line" === b.type ||
        ...
        for (m = 0; m < this._axes.length; m++)
          if (this._axes[m].dataInfo._dataRanges) {
            ...
            if (this._axes[m].scaleBreaks.customBreaks)
              for (
                u = 0;
                u < this._axes[m].scaleBreaks.customBreaks.length;
                u++
              )
                for (b = 0; b < f.length; b++)
                  if (
                    (this._axes[m].scaleBreaks.customBreaks[u].startValue <=
                      f[b].start &&
                      f[b].start <=
                        this._axes[m].scaleBreaks.customBreaks[u].endValue) ||
                    (this._axes[m].scaleBreaks.customBreaks[u].startValue <=
                      f[b].start &&
                      f[b].start <=
                        this._axes[m].scaleBreaks.customBreaks[u].endValue) ||
      ...
      if ("none" !== this.plotInfo.axisPlacement) {
        ...
        if (this.axisX && 0 < this.axisX.length)
          for (m = 0; m < this.axisX.length; m++)
            this.axisX[m].crosshair &&
              this.axisX[m].crosshair.enabled &&
              this.axisX[m].crosshair.renderLabel();
        if (this.axisX2 && 0 < this.axisX2.length)
          for (m = 0; m < this.axisX2.length; m++)
            this.axisX2[m].crosshair &&
              this.axisX2[m].crosshair.enabled &&
        ...
        if (this.axisY && 0 < this.axisY.length)
          for (m = 0; m < this.axisY.length; m++)
            this.axisY[m].crosshair &&
              this.axisY[m].crosshair.enabled &&
              this.axisY[m].crosshair.renderLabel();
        if (this.axisY2 && 0 < this.axisY2.length)
          for (m = 0; m < this.axisY2.length; m++)
            this.axisY2[m].crosshair &&
              this.axisY2[m].crosshair.enabled &&
              this.axisY2[m].crosshair.renderLabel();
      }
    };
        ...
        if (
          ...
          for (var u = 0; u < this.axisX.length; u++)
            this.axisX[u].crosshair &&
              this.axisX[u].crosshair.enabled &&
              (this.axisX[u].crosshair.hide(),
              this.axisX[u].crosshair.dispatchEvent(
                "hidden",
                { chart: this, axis: this.axisX[u].options },
                this.axisX[u].crosshair
              ));
          for (u = 0; u < this.axisX2.length; u++)
            this.axisX2[u].crosshair &&
              this.axisX2[u].crosshair.enabled &&
              (this.axisX2[u].crosshair.hide(),
              this.axisX2[u].crosshair.dispatchEvent(
                "hidden",
                { chart: this, axis: this.axisX2[u].options },
                this.axisX2[u].crosshair
              ));
          for (u = 0; u < this.axisY.length; u++)
            this.axisY[u].crosshair &&
              this.axisY[u].crosshair.enabled &&
              (this.axisY[u].crosshair.hide(),
              this.axisY[u].crosshair.dispatchEvent(
                "hidden",
                { chart: this, axis: this.axisY[u].options },
                this.axisY[u].crosshair
              ));
          for (u = 0; u < this.axisY2.length; u++)
            this.axisY2[u].crosshair &&
              this.axisY2[u].crosshair.enabled &&
              (this.axisY2[u].crosshair.hide(),
              this.axisY2[u].crosshair.dispatchEvent(
                "hidden",
                { chart: this, axis: this.axisY2[u].options },
                this.axisY2[u].crosshair
              ));
        } else
          this.panEnabled ||
          ...
          if (this.panEnabled)
            (e = {
              ...
              (m._panTimerId = setTimeout(
                (function (b, c, e, f) {
                  return function () {
                    m._zoomPanToSelectedRegion(b, c, e, f, !0) &&
                      (m._dispatchRangeEvent("rangeChanging", "pan"),
                      m.stockChart &&
                        m.stockChart.navigator &&
                        m.stockChart.navigator.enabled &&
                        ((m.stockChart._rangeEventParameter.type =
                          "rangeChanging"),
                        m.stockChart.dispatchEvent(
                          "rangeChanging",
                          m.stockChart._rangeEventParameter,
                          m.stockChart
                        )),
                      m.render(),
      ...
      for (m = 0; m < k.length; m++) {
        ...
        if (isFinite(p.dataInfo.minDiff))
          if (
            ...
            C.push(p), n.push({ val1: q, val2: g }), (u = !0);
          else if (!e) {
            u = !1;
            break;
          }
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        if (null !== v && "" !== v) {
          ...
          if ("normal" === this.plotInfo.axisPlacement) {
            ...
            "inside" !== z
              ? ((e = c.y1),
                ...
                0 < y
                  ? ((g =
                      n.point.y + ("horizontal" === A ? r / 2 : 0) - k - u - b),
                    g < e &&
                      ((g =
                        "auto" === z
                          ? Math.max(n.point.y, e) + r / 2 + u
                          : e + r / 2 + u),
                      (x = g + k > n.point.y)))
                  : ((g = n.point.y + r / 2 + u + b),
                    g > f - k &&
              ...
              : ((e = Math.max(n.bounds.y1, c.y1)),
                ...
                (b =
                  0 <= p.indexOf("range") || "error" === p
                    ? 0 < y
                      ? Math.max(n.bounds.y1, c.y1) + r / 2 + u
                      : Math.min(n.bounds.y2, c.y2) + r / 2 - k + u
                ...
                0 < y
                  ? ((g = Math.max(n.point.y, b)),
                    g < e &&
                      ("bubble" === p || "scatter" === p) &&
                      (g = Math.max(n.point.y - k - u, c.y1 + u)))
                  : ((g = Math.min(n.point.y, b)),
                    g > f - k - u &&
                      ("bubble" === p || "scatter" === p) &&
                      (g = Math.min(n.point.y + u, c.y2 - k - u))),
                (g = Math.min(g, f)));
          } else
            0 <= p.indexOf("line") ||
            0 <= p.indexOf("area") ||
              ...
              "inside" !== z
                ? ((e = c.x1),
                  ...
                  0 > y
                    ? ((q =
                      ...
                      q < e &&
                        ((q =
                          "auto" === z ? Math.max(n.point.x, e) + m : e + m),
                        (x = q + C > n.point.x)))
                    : ((q =
                        n.point.x + ("horizontal" === A ? 0 : r / 2) + m + b),
                      q > f - C - m - b &&
                        ((q =
                          "auto" === z
                ...
                : ((e = Math.max(n.bounds.x1, c.x1)),
                  ...
                  (b =
                    0 <= p.indexOf("range") || "error" === p
                      ? 0 > y
                        ? Math.max(n.bounds.x1, c.x1) + r / 2 + m
                        : Math.min(n.bounds.x2, c.x2) -
                          C / 2 -
                          m +
                          ("horizontal" === A ? 0 : r / 2)
          ...
          B &&
            ...
            d.setLineDash && d.setLineDash(N(l, B)),
            d.beginPath(),
        ...
        for (var f = [], m, u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          if (0 < n.length) {
            for (var A = !1, t = 0; t < n.length; t++)
              if (
                ((s = n[t].x.getTime ? n[t].x.getTime() : n[t].x),
                !(
                ...
                if ("number" !== typeof n[t].y)
                  ...
                  t < n.length - 1 &&
                    (h !== (n[t].lineColor || r) ||
                      p !== (n[t].lineDashType || k.lineDashType)) &&
                    (c.stroke(),
                    c.beginPath(),
                    c.moveTo(s, z),
                    (h = n[t].lineColor || r),
                  ...
                  if (0 < n[t].markerSize || 0 < k.markerSize) {
                    var D = k.getMarkerProperties(t, s, z, c);
                    f.push(D);
                    v = Q(v);
                    w &&
                      f.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], m, u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          if (0 < n.length) {
            for (var A = !1, t = 0; t < n.length; t++)
              if (
                ((s = n[t].getTime ? n[t].x.getTime() : n[t].x),
                !(
                  s < a.axisX.dataInfo.viewPortMin ||
                  (s > a.axisX.dataInfo.viewPortMax &&
                    (!k.connectNullData || !A))
                  ...
                  t < n.length - 1 &&
                    ...
                    c.setLineDash &&
                      (n[t].lineDashType
                        ...
                        : ((p = k.lineDashType), c.setLineDash(g))));
                  if (0 < n[t].markerSize || 0 < k.markerSize)
                    (v = k.getMarkerProperties(t, s, z, c)),
                      f.push(v),
                      (D = Q(D)),
                      w &&
                        f.push({
        ...
        for (var m = [], u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          if (0 < n.length)
            for (s = !1, l = 0; l < n.length; l++)
              if (
                ((t = n[l].getTime ? n[l].x.getTime() : n[l].x),
                !(
                ...
                if ("number" !== typeof n[l].y)
                  ...
                  l < n.length - 1 &&
                    (h !== (n[l].lineColor || r) ||
                      p !== (n[l].lineDashType || k.lineDashType)) &&
                    ((h = n[l].lineColor || r),
        ...
        for (g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < t.length) {
            ...
            for (k = 0; k < t.length; k++)
              if (
                ((b = t[k].x.getTime ? t[k].x.getTime() : t[k].x),
                !(
                ...
                if (
                  ...
                  (C[b] = t[k].y + (C[b] ? C[b] : 0)),
                    ...
                    (p = "undefined" !== typeof m[b] ? m[b] : q),
                    (m[b] = A);
                else if (
                  ((p = a.axisY.convertValueToPixel(t[k].y)), 0 <= t[k].y)
                ) {
                ...
                b = t[k].color
                  ? t[k].color
                  : l._colorSet[k % l._colorSet.length];
                ea(
                  c,
                  n,
                  ...
                  0,
                  null,
                  s && (a.axisY.reversed ? 0 > t[k].y : 0 <= t[k].y),
                  (a.axisY.reversed ? 0 <= t[k].y : 0 > t[k].y) && s,
                  !1,
                  !1,
                  l.fillOpacity
                );
    ...
    l.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < t.length)
            for (
              var s = 5 < r && l.bevelEnabled ? !0 : !1, k = 0;
              k < t.length;
              k++
            )
              if (
          ...
          if (0 < r.length) {
            ...
            for (f = 0; f < r.length; f++)
              if (
                ...
                ea(
                  c,
                  a.axisY.reversed ? m : t,
                  a.axisX.reversed ? l : u,
                  a.axisY.reversed ? t : m,
                  a.axisX.reversed ? u : l,
                  b,
                  0,
                  null,
                  h,
            ...
            for (k = 0; k < t.length; k++)
              if (
                ...
                if (
                  ...
                  (C[b] = t[k].y + (C[b] ? C[b] : 0)),
                    (n = m[b] ? m[b] : q),
                    (m[b] = A = a.axisY.convertValueToPixel(C[b]));
                else if (
                  ((n = a.axisY.convertValueToPixel(t[k].y)), 0 <= t[k].y)
                ) {
                  var v = f[b] ? f[b] : 0;
                  A = q + v;
                  n += v;
            ...
            for (k = 0; k < t.length; k++)
              if (
                ...
                if (
                  ...
                  (C[b] = z + (C[b] ? C[b] : 0)),
                    (n = m[b] ? m[b] : q),
                    (m[b] = z = a.axisY.convertValueToPixel(C[b]));
    ...
    l.prototype.renderArea = function (a) {
      ...
      function b() {
        v &&
          ...
          f.fill(),
          (f.globalAlpha = 1),
          w && (m.lineTo(l, A), m.lineTo(v.x, A), m.closePath(), m.fill()),
          f.beginPath(),
          f.moveTo(l, t),
          m.beginPath(),
          m.moveTo(l, t),
              ...
              if (
                ...
                if ("number" !== typeof r[h].y)
                  ...
                  0 !== r[h].markerSize &&
                    ...
                    ((s = g.getMarkerProperties(h, l, t, f)),
                    C.push(s),
                    (Y = Q(Y)),
                    w &&
                      C.push({
    ...
    l.prototype.renderSplineArea = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        w &&
          ...
          b.clearRect(u.x1, u.y1, u.width, u.height),
          this._eventManager.ghostCtx.restore());
        b.restore();
        return {
          source: c,
    ...
    l.prototype.renderStepArea = function (a) {
      ...
      function b() {
        y &&
          ...
          f.fill(),
          (f.globalAlpha = 1),
          w && (m.lineTo(s, v), m.lineTo(y.x, v), m.closePath(), m.fill()),
          f.beginPath(),
          f.moveTo(s, t),
          m.beginPath(),
          m.moveTo(s, t),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < r.length) {
            ...
            for (; l < r.length; l++)
              if (
                ((B = r[l].x.getTime ? r[l].x.getTime() : r[l].x),
                !(
                  B < a.axisX.dataInfo.viewPortMin ||
                  (B > a.axisX.dataInfo.viewPortMax &&
                    (!g.connectNullData || !c))
                ...
                "number" !== typeof r[l].y
                  ...
                  : ((s = a.axisX.convertValueToPixel(B)),
                    (t = a.axisY.convertValueToPixel(r[l].y)),
                    d || c
                      ? (!d && g.connectNullData
                          ? (f.setLineDash &&
                              (g.options.nullDataLineDashType ||
                            ...
                            f.lineTo(s, Y),
                            f.lineTo(s, t),
                            w && (m.lineTo(s, Y), m.lineTo(s, t)))
                          : (f.beginPath(),
                            f.moveTo(s, t),
                            w && (m.beginPath(), m.moveTo(s, t)),
                            (y = { x: s, y: t })),
                        (c = d = !1))
                      : (f.lineTo(s, Y),
                        w && m.lineTo(s, Y),
                    ...
                    l < r.length - 1 &&
                      (E !== (r[l].lineColor || x) ||
                        I !== (r[l].lineDashType || g.lineDashType)) &&
                      (b(),
                      (E = r[l].lineColor || x),
                      (f.strokeStyle = E),
                      f.setLineDash &&
                    ...
                    0 !== r[l].markerSize &&
                      (0 < r[l].markerSize || 0 < g.markerSize) &&
                      ((Y = g.getMarkerProperties(l, s, t, f)),
                      h.push(Y),
                      (B = Q(B)),
                      w &&
                        h.push({
            ...
            for (var Y = !0, q = 0; q < n.length; q++) {
              ...
              if (
                ...
                if ("number" !== typeof fa.y)
                  ...
                  q < x.length - 1 &&
                    (I !== (x[q].lineColor || E) ||
                      t !== (x[q].lineDashType || D.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, r),
                    k.push({ x: g, y: B - aa }),
                    ...
                    b.setLineDash &&
                      (x[q].lineDashType
                        ? ((t = x[q].lineDashType),
                          b.setLineDash(N(t, D.lineThickness)))
                        : ((t = D.lineDashType), b.setLineDash(ba))));
                  if (0 <= D.dataPointIndexes[f]) {
    ...
    l.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < B.length)
            for (
              var z = 5 < r && t.bevelEnabled ? !0 : !1, u = 0;
              u < B.length;
              u++
            )
              if (
                (B[u].getTime ? (g = B[u].x.getTime()) : (g = B[u].x),
                !(
                  g < a.axisX.dataInfo.viewPortMin ||
                  g > a.axisX.dataInfo.viewPortMax
                ) &&
                  !s(B[u].y) &&
                  B[u].y.length &&
                  "number" === typeof B[u].y[0] &&
                  "number" === typeof B[u].y[1] &&
                  "number" === typeof B[u].y[2] &&
                  "number" === typeof B[u].y[3])
              ) {
                ...
                "candlestick" === t.type
                  ? (c.moveTo(h - x, n),
                    ...
                    ea(
                      ...
                      y,
                      Math.max(k, q),
                      B[u].y[0] <= B[u].y[3] ? t.risingColor : f,
                      D,
                      e,
                      z,
                      z,
    ...
    l.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var l = !1, l = !!a.axisY.reversed, v = 0;
          ...
          if (0 < z.length)
            for (
              var A = 5 < r && B.bevelEnabled ? !0 : !1, m = 0;
              m < z.length;
              m++
            )
              if (
                (z[m].getTime ? (g = z[m].x.getTime()) : (g = z[m].x),
                !(
                  g < a.axisX.dataInfo.viewPortMin ||
                  g > a.axisX.dataInfo.viewPortMax
                ) &&
                  !s(z[m].y) &&
                  z[m].y.length &&
                  "number" === typeof z[m].y[0] &&
                  "number" === typeof z[m].y[1] &&
                  "number" === typeof z[m].y[2] &&
                  "number" === typeof z[m].y[3] &&
                  "number" === typeof z[m].y[4] &&
                  5 === z[m].y.length)
              ) {
                ...
                var y = (u - r / 2) << 0,
                  ...
                  I = z[m].whiskerColor
                    ...
                    : e,
                  R =
                    "number" === typeof z[m].whiskerThickness
                      ? z[m].whiskerThickness
                      : "number" === typeof B.options.whiskerThickness
                      ? B.whiskerThickness
                      : x,
                  ba = z[m].whiskerDashType
                    ? z[m].whiskerDashType
                    : B.whiskerDashType,
                  Y = s(z[m].whiskerLength)
                  ...
                  la = z[m].stemColor
                    ...
                    : e,
                  aa =
                    "number" === typeof z[m].stemThickness
                      ? z[m].stemThickness
                  ...
                  M = z[m].lineColor
                    ...
                    : e,
                  L =
                    "number" === typeof z[m].lineThickness
                      ? z[m].lineThickness
                      : "number" === typeof B.options.lineThickness
                      ? B.lineThickness
                      : x,
                  O = z[m].lineDashType ? z[m].lineDashType : B.lineDashType,
                ...
                0 < R &&
                  ...
                  (c.strokeStyle = I),
                  (c.lineWidth = R),
                  c.moveTo((u - Y / 2) << 0, p - fa),
                  c.lineTo((u + Y / 2) << 0, p - fa),
                  c.stroke(),
                  c.moveTo((u - Y / 2) << 0, h + fa),
                  c.lineTo((u + Y / 2) << 0, h + fa),
                  c.stroke());
                c.restore();
                w &&
                  ((e = Q(P)),
                  ...
                  0 < aa &&
                    (b.moveTo(u - E - G, k),
                    b.lineTo(u - E - G, Math.max(h, p)),
                    b.stroke(),
                    b.moveTo(u - E - G, Math.min(h, p)),
                    b.lineTo(u - E - G, n),
                    b.stroke()),
                  ea(
                    b,
          ...
          if (0 < g.length)
            for (
              ...
              if (
                ...
                ea(
                  c,
                  a.axisX.reversed ? v : l,
                  m,
                  a.axisX.reversed ? l : v,
                  u,
                  b,
                  0,
                  b,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
          var z = a.dataSeriesIndexes[B],
            ...
            E = 0;
          if (D)
            for (e = A._linkedSeries.id, t = 0; t < e; t++)
              !this.data[t].type.match(/(bar|column)/gi) ||
                !this.data[t].visible ||
                (this.data[t].type.match(/(stacked)/gi) && E) ||
                (this.data[t].type.match(/(range)/gi) && (f = !0), E++);
          e = this.options.dataPointMinWidth
            ? this.dataPointMinWidth
            : this.options.dataPointWidth
            ? this.dataPointWidth
            ...
            for (var F = A._colorSet, u = 0; u < x.length; u++) {
              var e = (A.lineColor = A.options.color ? A.options.color : F[0]),
                I = {
                  color: x[u].whiskerColor
                    ...
                    ? A.whiskerColor
                    : e,
                  thickness: s(x[u].whiskerThickness)
                    ? A.whiskerThickness
                    : x[u].whiskerThickness,
                  dashType: x[u].whiskerDashType
                    ? x[u].whiskerDashType
                    : A.whiskerDashType,
                  length: s(x[u].whiskerLength)
                    ? s(A.options.whiskerLength)
                      ? t
                      : A.options.whiskerLength
                    : x[u].whiskerLength,
                  trimLength: s(x[u].whiskerLength)
                    ? s(A.options.whiskerLength)
                      ? 50
                      : 0
                    : 0,
              ...
              var R = {
                color: x[u].stemColor
                  ...
                  ? A.stemColor
                  : e,
                thickness: x[u].stemThickness
                  ? x[u].stemThickness
                  : A.stemThickness,
                dashType: x[u].stemDashType
                  ? x[u].stemDashType
                  : A.stemDashType,
              };
              R.thickness =
              ...
              if (
                ...
                !s(x[u].y) &&
                x[u].y.length &&
                "number" === typeof x[u].y[0] &&
                "number" === typeof x[u].y[1]
              ) {
                ...
                b
                  ? ((q = a.axisX.reversed
                      ? (k + ((D ? v : 1) * t) / 2 - (D ? E - 1 : 0) * t) << 0
                      : (k - ((D ? v : 1) * t) / 2 + (D ? E - 1 : 0) * t) << 0),
                    (g = a.axisX.reversed ? (q - t) << 0 : (q + t) << 0))
                  : ((n = a.axisX.reversed
                      ? (h + ((D ? v : 1) * t) / 2 - (D ? E - 1 : 0) * t) << 0
                      : (h - ((D ? v : 1) * t) / 2 + (D ? E - 1 : 0) * t) << 0),
                    (p = a.axisX.reversed ? (n - t) << 0 : (n + t) << 0));
                !b && q > g && ((ba = q), (q = g), (g = ba));
                b && n > p && ((ba = n), (n = p), (p = ba));
                ba = A.dataPointIds[u];
        ...
        for (var u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          if (0 < p.length) {
            ...
            for (var I = !0; g < p.length; g++)
              if (
                ((t = p[g].x.getTime ? p[g].x.getTime() : p[g].x),
                !(
                  t < a.axisX.dataInfo.viewPortMin ||
                  (t > a.axisX.dataInfo.viewPortMax &&
                    (!n.connectNullData || !I))
                ...
                if (
                  ...
                  if (
                    ...
                    R = n.getMarkerProperties(g, r, l, b);
                    f.push(R);
                    ba = Q(t);
                    w &&
                      f.push({
        ...
        for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < v.length)
            for (
              ...
              if (
                (v[m].getTime ? (n = v[m].x.getTime()) : (n = v[m].x),
                "number" !== typeof v[m].y)
              ) {
                if (0 < m && !x && s.connectNullData)
                  var E =
                    s.options.nullDataLineDashType || !v[m - 1].lineDashType
                ...
                l =
                  0 === s.dataPointEOs[m].cumulativeSum
                    ? p
                    : a.axisY.convertValueToPixel(
                        s.dataPointEOs[m].cumulativeSum
                      );
                k =
                  0 === s.dataPointEOs[m].cumulativeSumYStartValue
                    ? p
                    : a.axisY.convertValueToPixel(
                        s.dataPointEOs[m].cumulativeSumYStartValue
                      );
                h = a.axisX.reversed
                  ? (h +
                ...
                ea(
                  ...
                  a.axisY.reversed ? k : l,
                  a.axisX.reversed ? h : F,
                  a.axisY.reversed ? l : k,
                  I,
                  0,
                  I,
                  z,
                ...
                0 < m &&
                  y &&
                  (!x || s.connectNullData) &&
                  (x && c.setLineDash && c.setLineDash(N(E, t)),
                  c.beginPath(),
                  c.moveTo(y, D - B),
                  c.lineTo(I, R - B),
                  0 < t && c.stroke(),
              ...
              null !== h &&
                ...
                c - l < r &&
                  ...
                  +h.toFixed(B) < +k.toFixed(B) &&
                    (m = c > r ? c - r : l - (k - h)))));
          m &&
            ((d = p.indexLabelTextBlock.y + m),
            (c = 0),
            (c =
              "right" === p.hemisphere
                ? z.x + Math.sqrt(Math.pow(v, 2) - Math.pow(d - z.y, 2))
                : z.x - Math.sqrt(Math.pow(v, 2) - Math.pow(d - z.y, 2))),
            p.midAngle > Math.PI / 2 - t && p.midAngle < Math.PI / 2 + t
          ...
          if ("inside" !== k.indexLabelPlacement) {
            ...
            for (a = 0; a < n.length; a++)
              (h = g[a]),
                ...
                (t = z.x + v * Math.cos(h.midAngle)),
                (s = z.y + v * Math.sin(h.midAngle)),
                (h.indexLabelTextBlock.x = t),
                (h.indexLabelTextBlock.y = s);
          for (a = 0; a < n.length; a++)
            if (
              ((h = g[a]),
              (t = h.indexLabelTextBlock.measureText()),
              0 !== t.height && 0 !== t.width)
            )
              (t = t = 0),
                "right" === h.hemisphere
                  ? ((t =
                ...
                0 < t &&
                  ...
                  ((t /= Math.abs(Math.cos(h.indexLabelAngle))),
                  9 < t && (t *= 0.3),
                  t > d && (d = t)),
                (t = t = 0),
                ...
                0 < t &&
                  ...
                  Math.abs(h.indexLabelTextBlock.x - z.x) < D &&
                    ((t /= Math.abs(Math.sin(h.indexLabelAngle))),
                    9 < t && (t *= 0.3),
                    t > d && (d = t)));
    ...
    l.prototype.renderFunnel = function (a) {
      ...
      function c() {
        ...
        if (0 === g) return -1;
        for (
          var m = (d[0] = 0), h = 0, n, p, b = b - a, m = !1, k = 0;
          k < B.length;
          k++
        )
        ...
        if (t && B) {
          ...
          for (var A = 0, D = B.length - 1; A < B.length || 0 <= D; A++, D--) {
            ...
            a = b.color
              ? b.color
              : t.reversed
              ? t._colorSet[(B.length - 1 - A) % t._colorSet.length]
              : t._colorSet[A % t._colorSet.length];
            ...
            b = b.indexLabelFormatter
              ...
              : b.indexLabel
              ? x.replaceKeywordsWithValue(b.indexLabel, b, t, A)
              : t.indexLabelFormatter
              ? t.indexLabelFormatter(y)
              : t.indexLabel
              ? x.replaceKeywordsWithValue(t.indexLabel, b, t, A)
              : b.label
              ? b.label
              : "";
            0 >= n && (n = 0);
      ...
      function e() {
        ...
        if (e)
          for (m = H.length - 1; 0 <= m; m--)
            (a = P[m]),
              (H[m].textBlock.maxWidth = f[f.length - (m + 1)]),
              H[m].textBlock.measureText(),
              (H[m].textBlock.x = L - k),
              (c =
                H[m].textBlock.height < H[m].textBlock.maxHeight
                  ? H[m].textBlock.height
                  : H[m].textBlock.maxHeight),
              (e =
                H[m].textBlock.width < H[m].textBlock.maxWidth
                  ? H[m].textBlock.width
                  : H[m].textBlock.maxWidth),
              (H[m].height = c),
              (H[m].width = e),
              (c =
                "undefined" !== typeof a.x5
                  ? (a.y2 + a.y4) / 2
                  : (a.y2 + a.y3) / 2),
              (H[m].textBlock.y = c - H[m].height / 2),
              t.reversed
                ? (H[m].textBlock.y + H[m].height > V + A &&
                    (H[m].textBlock.y = V + A - H[m].height),
                  H[m].textBlock.y < qa - A && (H[m].textBlock.y = qa - A))
                : (H[m].textBlock.y < V - A && (H[m].textBlock.y = V - A),
                  H[m].textBlock.y + H[m].height > qa + A &&
                    (H[m].textBlock.y = qa + A - H[m].height));
      }
      function f() {
        var a, b, c, d;
      ...
      function m() {
        ...
        function b() {
          ...
          for (var k, h = 1; h < m; h++) {
            ...
            for (var l = H.length - 1; 0 <= l; l--)
              !H[l].isDirty &&
                H[l].textBlock.y < e &&
                H[l].textBlock.y + H[l].height > e &&
                ((k = q(l)),
                !(k >= H.length - 1) &&
                  H[l].textBlock.y + H[l].height + da > H[k].textBlock.y &&
                  (H[l].textBlock.y =
                    H[l].textBlock.y + H[l].height - e > e - H[l].textBlock.y
                      ? e + 1
                      : e - H[l].height - 1));
          }
        ...
        for (var d, e, f, g, m, k, n = 1, l = 0; l < 2 * n; l++) {
          for (
            ...
            (f = H[r]),
            (g = f.textBlock),
            (k = (m = q(r) < P.length ? H[q(r)] : null) ? m.textBlock : null),
      ...
      function h(a, b) {
        return (
          (b < P.length ? H[b].textBlock.y : t.reversed ? V + A : qa + A) -
          (0 > a
            ? t.reversed
              ? qa - A
              : V - A
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        ("inside" !== t.indexLabelPlacement && I) ||
          (y = (z.width - 0.75 * F) / 2);
        var R = z.x1 + y,
          L = z.x2 - y,
          Y = z.y1 + A,
        ...
        if (0 != t.length && t.dataPoints && t.visible && 0 !== B.length) {
          ...
          var S = (30 * (L - a)) / 100;
          "funnel" === t.type
            ? ((aa = s(t.options.neckHeight) ? 0.35 * E : t.neckHeight),
              ...
              G > a ? (G = a - 0.5) : 0 >= G && (G = 0))
            : "pyramid" === t.type &&
              ((G = aa = 0), (t.reversed = t.reversed ? !1 : !0));
          var y = R + a / 2,
            U = R,
            Z = R + a,
            V = t.reversed ? O : Y,
          ...
          if (-1 !== R) {
            ...
            for (G = 0; G < R.length - 1; G++)
              (T = t.reversed
                ? B[B.length - 1 - G].color
                  ? B[B.length - 1 - G].color
                  : t._colorSet[(B.length - 1 - G) % t._colorSet.length]
                : B[G].color
                ? B[G].color
            ...
            for (G = 0; G < B.length; G++)
              B[G].exploded &&
                ((R = !0), t.reversed ? W.push(B.length - 1 - G) : W.push(G));
            ...
            if (
              I &&
              t.visible &&
              (b(), f(), e(), "inside" !== t.indexLabelPlacement)
            ) {
              m();
              for (G = 0; G < B.length; G++)
                H[G].isDirty ||
            ...
            for (G = 0; G < P.length; G++)
              (D = P[G]), na(Q, D, t.fillOpacity), ha.push(D.y1);
            v(Q);
            I &&
              t.visible &&
              ("inside" === t.indexLabelPlacement || x.animationEnabled || n(Q),
    ...
    l.prototype.exportChart = function (a) {
      ...
      if (b && d && c) {
        ...
        if ("undefined" !== typeof Blob && new Blob()) {
          for (
            var m = b.replace(/^data:[a-z\/]*;base64,/, ""),
              m = atob(m),
              h = new ArrayBuffer(m.length),
              h = new Uint8Array(h),
              l = 0;
            l < m.length;
            l++
      ...
      return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
        ...
        if ("color" === a)
          return "waterfall" === c.type
            ...
            ? c.color
              ? c.color
              : c._colorSet[m % c._colorSet.length]
            : d.color
            ? d.color
            : c.color
            ? c.color
          ...
          if (
            ...
            var q = (p.legendMarkerType = p.legendMarkerType
              ...
              w = p.legendMarkerBorderColor
                ...
                : p.markerBorderColor,
              t = p.legendMarkerBorderThickness
            ...
            for (var x = 0; x < p.dataPoints.length; x++) {
              var z = p.dataPoints[x],
                ...
                w = z.legendMarkerBorderColor
                  ...
                  ? z.markerBorderColor
                  : p.markerBorderColor,
                t = z.legendMarkerBorderThickness
          ...
          if (a && 0 < a.length)
            for (x = [], g = T = 0; g < a.length; g++)
              a[g] && (a[g].lineCoordinates = {}),
                (a[g].lineCoordinates.width = Math.abs(l - m)),
                a[g].title &&
          ...
          if (d && 0 < d.length)
            for (z = [], g = X = 0; g < d.length; g++)
              d[g] && (d[g].lineCoordinates = {}),
                (d[g].lineCoordinates.width = Math.abs(l - m)),
                d[g].title &&
          ...
          if (a && 0 < a.length)
            for (g = 0; g < a.length; g++)
              a[g] &&
                ...
                (k = Math.round(f.y2)),
                (a[g].lineCoordinates.x2 = l),
                (a[g].lineCoordinates.width = l - m),
            ...
            for (g = 0; g < a.length; g++)
              a[g] &&
                ...
                a[g]._labels &&
                  ...
                  (m = a[g].getApparentDifference(a[g].viewportMinimum, m)),
                  (E = a[g].logarithmic
                    ? (1 < m
                        ? (Math.log(m) /
                            a[g].conversionParameters.lnLogarithmBase) *
                    ...
                    : (0 < m
                        ? m * Math.abs(a[g].conversionParameters.pixelPerUnit)
                        : 0) + a[g].lineCoordinates.x1)));
          if (d && 0 < d.length)
            for (g = 0; g < d.length; g++)
              d[g].calculateValueToPixelConversionParameters(),
                ...
                d[g]._labels &&
                  ...
                  (m = d[g].getApparentDifference(d[g].viewportMinimum, m)),
                  (E = d[g].logarithmic
                    ? (1 < m
                        ? (Math.log(m) /
                            d[g].conversionParameters.lnLogarithmBase) *
                    ...
                    : (0 < m
                        ? m * Math.abs(d[g].conversionParameters.pixelPerUnit)
                        : 0) + d[g].lineCoordinates.x1));
          for (g = 0; g < q.length; g++)
            "axisY" === q[g].type &&
                  ...
                  0 < !d.length &&
                    (l =
                      0 < c[g].labelAngle
                        ...
                        ? l - z / 2
                        : l)),
                (c[g].lineCoordinates.x1 = m),
                (c[g].lineCoordinates.x2 = l),
                (c[g].lineCoordinates.width = Math.abs(l - m)),
                c[g].title &&
                  (c[g]._titleTextBlock.maxWidth =
                    0 < c[g].titleMaxWidth &&
                  ...
                  (0 < !a.length &&
                    (m =
                      0 < b[g].labelAngle
                        ...
                        : m),
                  0 < !d.length && (l -= y / 2)),
                (b[g].lineCoordinates.x1 = m),
                (b[g].lineCoordinates.x2 = l),
                (b[g].lineCoordinates.width = Math.abs(l - m)),
                b[g].title &&
                  (b[g]._titleTextBlock.maxWidth =
                    0 < b[g].titleMaxWidth &&
            ...
            for (g = 0; g < d.length; g++) {
              ...
              if (b && 0 < b.length)
                for (K = 0; K < b.length; K++)
                  b[K] &&
                    b[K].labelAutoFit &&
                    ((l = b[K].lineCoordinates.x2), (m = l - T));
              d[g].lineCoordinates = {
                x1: l + Q,
                y1: h,
                x2: l + Q,
    ...
    x.render = function (a, d, c, b, e) {
      ...
      if (a && 0 < a.length)
        for (m = 0; m < a.length; m++)
          a[m].renderStripLinesOfThicknessType("value");
      if (d && 0 < d.length)
      ...
      if (d && 0 < d.length)
        for (m = 0; m < d.length; m++)
          d[m].renderGrid(),
            w && (d[m].createMask(), d[m].renderBreaksBackground());
      if (c && 0 < c.length)
        for (m = 0; m < c.length; m++)
          c[m].renderGrid(),
            w && (c[m].createMask(), c[m].renderBreaksBackground());
      if (b && 0 < b.length)
        for (m = 0; m < b.length; m++)
          b[m].renderGrid(),
            w && (b[m].createMask(), b[m].renderBreaksBackground());
      if (a && 0 < a.length)
        ...
        if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
          if (s(this.scaleBreaks.lastBreakIndex))
            ...
            for (
              ...
              d.moveTo(m, e),
                d.lineTo(m, this.scaleBreaks._appliedBreaks[h].startPixel + b),
          ...
          if (
            ...
            "top" === this.scaleBreaks.parent._position
              ? ((e = this.chart.plotArea.y1),
                (l = (this.chart.plotArea.y2 + p / 2 + 0.5) << 0))
              : ((e = this.chart.plotArea.y2),
                (l = (this.chart.plotArea.y1 - p / 2 + 0.5) << 0),
                (a *= -1)),
            (this.bounds = { x1: b - p / 2, y1: e, x2: h + p / 2, y2: l }),
            this.ctx.moveTo(b, e),
            "straight" === this.type ||
              ("top" === this.scaleBreaks.parent._position && 0 >= a) ||
              ("bottom" === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(b, l), this.ctx.lineTo(h, l), this.ctx.lineTo(h, e);
          ...
          if (
            ...
            "left" === this.scaleBreaks.parent._position
              ...
              : ((b = this.chart.plotArea.x2),
                ...
                (a *= -1)),
            (this.bounds = { x1: b, y1: e - p / 2, x2: h, y2: l + p / 2 }),
            this.ctx.moveTo(b, e),
            "straight" === this.type ||
              ("left" === this.scaleBreaks.parent._position && 0 >= a) ||
              ("right" === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(h, e), this.ctx.lineTo(h, l), this.ctx.lineTo(b, l);
          else if ("wavy" === this.type) {
            s = b;
            k = e;
            f = 0.5;
      ...
      if (0 < d) {
        ...
        if (
          ...
          (e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0),
            ...
            (this.bounds = { x1: e - d / 2, y1: h, x2: f + d / 2, y2: l });
        else if (
          ...
          (h = l = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0),
            ...
            (this.bounds = { x1: e, y1: h - d / 2, x2: f, y2: l + d / 2 });
        this.ctx.moveTo(e, h);
        this.ctx.lineTo(f, l);
        this.ctx.stroke();
    ...
    ca.prototype.render = function (a, d, c) {
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          if (
            ...
            for (
              ...
              if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                ...
                (z += n[r].dataPoint.y),
                  (t = Math.abs(a - this.parent.convertValueToPixel(z))),
                  t < w && ((w = t), (y = r));
            ...
            for (
              ...
              if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                ...
                (z += n[r].dataPoint.y),
                  ...
                  (t = Math.abs(a - this.parent.convertValueToPixel(A))),
                  t < w && ((w = t), (y = r));
          else
            for (
              w = Math.abs(
          ...
          if (
            ...
            if (
              ...
              for (r = t = 0; r < B.dataPoint.y.length; r++)
                (t = Math.abs(
          ...
          if (
            ...
            for (
              ...
              if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                ...
                (z += n[r].dataPoint.y),
                  (t = Math.abs(d - this.parent.convertValueToPixel(z))),
                  t < w && ((w = t), (y = r));
          else if (
              ...
              if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                ...
                (z += n[r].dataPoint.y),
                  (A = n[r].dataPoint.x.getTime
                    ...
                    : n[r].dataPoint.x),
                  (A = 100 * (z / n[r].dataSeries.plotUnit.dataPointYSums[A])),
                  (t = Math.abs(d - this.parent.convertValueToPixel(A))),
                  t < w && ((w = t), (y = r));
          else
            for (
              w = Math.abs(
        ...
        if (
          ...
          (b = e = l = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0),
            (f = this.chart.plotArea.y1),
            (h = this.chart.plotArea.y2),
            (this.bounds = { x1: b - p / 2, y1: f, x2: e + p / 2, y2: h });
        else if (
            ...
            for (var v = 0; v < this.chart.axisX.length; v++) {
              for (
                ...
                (k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(h, c)) &&
                  ...
                  null !== k.dataPoint.y && k.dataSeries.visible && l.push(k));
              k = null;
            }
